...
nPoints = 1200;
nDetectsPerPoint = 20; % mean, poisson distributed

nRandPoints = 40;

precMod = 4; % Multiplier to precision here
...
%% Save figures to disk
    ...
    print(1,fullfile('C:\Users\Rusty Nicovich\Documents\MATLAB\meshFitting\manuscript\figures', ...
                    sprintf('FitPoints2d_pts-%.f_period-%.2f.png', nPoints, calcPeriod)), '-dpng');
    print(2,fullfile('C:\Users\Rusty Nicovich\Documents\MATLAB\meshFitting\manuscript\figures', ...
                    sprintf('GroundTruth2d_pts-%.f_period-%.2f.png', nPoints, calcPeriod)), '-dpng');
    print(3,fullfile('C:\Users\Rusty Nicovich\Documents\MATLAB\meshFitting\manuscript\figures', ...
